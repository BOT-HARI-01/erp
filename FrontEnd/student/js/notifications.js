...
let notifications = [
    {
        ...
        message: 'Your Semester 6 tuition fee payment of ₹25,000 is pending. Please pay immediately to avoid late charges.',
        time: '2 hours ago',
        read: false,
    ...
    },
    {
        ...
        message: 'Your attendance in "Compiler Design" has dropped to 68%. You need 75% to appear for exams.',
        time: '5 hours ago',
        read: false,
    ...
    },
    {
        ...
        message: 'You have successfully returned "Intro to Algorithms". No fines applicable.',
        time: '1 day ago',
        read: true,
        icon: 'fa-book'
    },
    {
        ...
        message: 'The schedule for Mid-Semester Exams has been published. Check the dashboard for details.',
        time: '2 days ago',
        read: true,
    ...
    },
    {
        ...
        message: 'Payment of ₹30,000 for Hostel Block A received via Transaction ID #998877.',
        time: '3 days ago',
        read: true,
...
function renderNotifications(filterType) {
    ...
    filteredData.forEach(item => {
        ...
        // CSS classes based on type/priority
...
function markAllAsRead() {
    ...
    // Re-render current view to remove dots
    const activeTab = document.querySelector('.tab-btn.active');
    // Determine filter based on button text (simple mapping)
    let type = 'all';
