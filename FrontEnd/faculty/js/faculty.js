...
async function loadFacultyDashboard() {
    ...
    try {
        ...
        // 1. Fetch Profile (Corrected Route: /get-profile)
        const resProfile = await fetch('http://127.0.0.1:8000/faculty/get-profile', {
        ...
        if(resProfile.ok) {
            ...
            if(document.getElementById("fac-name"))
                document.getElementById("fac-name").innerText = profile.last_name || "Faculty";
            ...
            if(document.getElementById("p-qual"))
                document.getElementById("p-qual").innerText = profile.qualification || "N/A";
            if(document.getElementById("p-exp"))
                document.getElementById("p-exp").innerText = `${profile.experience || 0} Years`;
        }
