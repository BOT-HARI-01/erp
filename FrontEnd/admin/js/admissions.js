async function uploadStudents() {
    ...
    statusBox.innerHTML = "<span style='color:blue'>Uploading... Please wait.</span>";

    try {
        // Matches router: @router.post("/upload-students")
        const response = await fetch('http://127.0.0.1:8000/admin/upload-students', {
            method: 'POST',
            headers: {
